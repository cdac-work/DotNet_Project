...
namespace rashi_try.Controllers
{
    public class BusesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("BusId,BusNumber,Capacity,BusType")] Bus bus)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BusId,BusNumber,Capacity,BusType")] Bus bus)
        {
            if (id != bus.BusId)
            {
                return NotFound();
